  ...
  <div>
    <el-row :gutter="16">
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" :inline="true" label-width="100px">
        <el-col :xl="24" :lg="24" :md="24" :sm="24" :xs="24" style="text-align: right">
          <el-button type="primary" v-db-click style="float: left" @click="addMember">新增经销商</el-button>
...
import { memberList } from '@/api/memberManage/list'
...
export default {
  ...
  methods: {
    ...
    initSession() {
      ...
      let sessionLevel;
      if (sessionData.constant) {
        sessionLevel = sessionData.constant.level // 权限数据
      }
      if (sessionLevel) {
