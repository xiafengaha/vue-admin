      ...
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" :inline="true" label-width="100px" style="overflow: hidden">
        <el-col :span="24" style="text-align: right">
          <el-button v-db-click type="primary" style="float: left">
            <a href="/admin/wareGoodsOutPut.json" target="_blank">导出报表</a>
          </el-button>
          <el-form-item>
            <el-input placeholder="请输入上级经销商"></el-input>
          </el-form-item>
          <el-form-item>
            <el-input placeholder="请输入推荐人"></el-input>
          </el-form-item>
          <el-form-item>
            <el-select
              v-model="ruleForm.level_id"
              clearable
              placeholder="请选择推荐人等级">
              <el-option
          ...
          <el-form-item>
            ...
            <el-button v-db-click type="primary" @click="searchList(ruleForm)">搜 索</el-button>
          </el-form-item>
        </el-col>
